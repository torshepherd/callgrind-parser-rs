...
`docs/SOURCE-AUDIT.md`. The 12-profile native parsing gate is implemented;
CI/Nix validation, then the pprof converter, are next. Use `docs/HANDOFF.md`
for the current recovery and implementation contract.
