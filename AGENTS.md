...
changes. Never force-push. With the GitHub tree API, require the actual nonempty
base tree and verify the complete prospective file set, blob IDs and modes
before updating the ref. Commit source, lockfiles, and handoff notes to Git.
